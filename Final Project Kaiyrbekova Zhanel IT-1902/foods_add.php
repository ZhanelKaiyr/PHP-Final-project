...
<div class="admin-wrapper">
    ...
    <div class="admin-content">
        <div class="button-group">
            <a href="foods_update.php" class="">Update Menu</a>
        ...
        <div class="content">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <label for="menu_href">Menu href:</label>
                    <input type="text" name="menu_href" id="menu_href" placeholder="Menu href...">
                </div>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if (empty($food_name) || empty($food_image) || empty($food_cost) || empty($menu_href) || empty($food_count)) {
                    echo "<script type='text/javascript'>alert('All fields are required!')</script>";
                    return;
                }

                $sql = "INSERT INTO foods (food_name, food_image, food_cost, food_count, menu_href) VALUES (?, ?, ?, ?, ?)";

                $stmt = $link->prepare($sql);
                $stmt->bind_param("sssss", $food_name, $food_image, $food_cost, $food_count, $menu_href);
                ...
                if ($results === false){
                    ...
                    $id = $stmt->insert_id;
                    echo "<script type='text/javascript'>alert('Inserted food with ID: $id')</script>";
                }
                $stmt->close();
            }
            ?>
