    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-5.jpg" alt="" width="100%">
                </div>
                <div>
                    <?php
                    include 'main.php';
                    class menu5 extends main{

                        public function information(){
                            print 'Probably there is no such person in Kazakhstan who does not like Baursaks. Soft and airy in texture. I want to eat them without stopping.';
                            print '<br>';
                        }

                    }

                    $menu5 = new menu5("Bayursaki",390,"mayonnaise, yeast dough, butter");
                    $menu5->information();
