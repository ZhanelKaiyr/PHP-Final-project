    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-1.jpg" alt="" width="100%">
                </div>
                <div>
                    <?php
                    include 'main.php';
                    class menu1 extends main{

                        public function information(){
                            print 'Delicious chicken soup with homemade noodles will fill your home with aromas of warmth and comfort.';
                            print '<br>';
                        }

                    }

                    $menu1 = new menu1("Homemade noodles",835,"Chicken, noodles, chicken stock, greens");
                    $menu1->information();
                    ?>
