    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-2.jpg" alt="" width="100%">
                </div>
                <div>
                    <?php
                    include 'main.php';
                    class menu2 extends main{
                        ...
                        public function information(){
                            print 'Dumplings are boiled in boiling salted water with onions (can be husked) and bay leaf or in broth.';
                            print '<br>';
                        }

                    }

                    $menu2 = new menu2("Dumplings",880,"minced beef, dough, bay leaf");
                    $menu2->information();
