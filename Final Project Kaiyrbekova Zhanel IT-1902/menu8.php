    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-8.jpg" alt="" width="100%">
                </div>
                <div>

                    <?php
                    include 'main.php';
                    class menu8 extends main{

                        public function information(){
                            print 'This Russian soup has an unusual sour-salty-spicy taste. But despite the riot of the culinary palette, it is really delicious.';
                            print '<br>';
                        }

                    }

                    $menu8 = new menu8("Solyanka  ",940,"meat, smoked and boiled sausage, chicken roll, pickles, olives, lemon");
                    $menu8->information();
