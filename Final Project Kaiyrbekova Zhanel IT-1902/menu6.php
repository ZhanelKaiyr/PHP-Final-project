    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-6.jpg" alt="" width="100%">
                </div>
                <div>

                    <?php
                    include 'main.php';
                    class menu6 extends main{

                        public function information(){
                            print 'Pancakes with holes. Well, what without them? No way. A simple recipe for delicious pancakes with holes is even for a novice hostess.';
                            print '<br>';
                        }

                    }

                    $menu6= new menu6("Pancakes with sour cream",680,"milk, flour, sugar,sour cream");
                    $menu6->information();
