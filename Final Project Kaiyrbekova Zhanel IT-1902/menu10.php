    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-10.png" alt="" width="100%">
                </div>
                <div>

                    <?php
                    include 'main.php';
                    class menu10 extends main{

                        public function information(){
                            print 'This vegetable salad is difficult to describe in one word - it is bright, juicy, crunchy, piquant, memorable, very tasty and fragrant! Such a vegetable salad will be an excellent snack or addition to meat dishes.';
                            print '<br>';
                        }

                    }

                    $menu10 = new menu10("Fresh salad  ",600,"Fresh tomatoes and cucumbers, greens, dressing of your choice oil or mayonnaise");
                    $menu10->information();
