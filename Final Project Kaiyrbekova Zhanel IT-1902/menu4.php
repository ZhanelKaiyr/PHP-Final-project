    ...
    <div class="shadowed">
        <section class="menu-container menu-section" style="color:#F5A7BC;">
            ...
            <div class="menu-items">
                <div>
                    <img src="img\menu-4.jpg" alt="" width="100%">
                </div>
                <div>
                    <?php
                    include 'main.php';
                    class menu4 extends main{

                        public function information(){
                            print 'The owners of the secrets of cooking such cutlets simply do not have the price, because the minced meat patties in the pan are an irreplaceable hit for all time and the magic wand that adorns any table.';
                            print '<br>';
                            print 'Who said that mashed potatoes are not festive, you just did not cook it according to this recipe.';
                            print '<br>';
                        }

                    }

                    $menu4 = new menu4("Cutlets with side dish",980,"minced beef or chicken, onions, potatoes");
